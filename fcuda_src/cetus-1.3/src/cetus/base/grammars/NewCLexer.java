// $ANTLR 2.7.7 (2006-11-01): "NewCParser.g" -> "NewCLexer.java"$
...
public NewCLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("__real", this), new Integer(109));
	literals.put(new ANTLRHashString("case", this), new Integer(65));
	literals.put(new ANTLRHashString("short", this), new Integer(29));
	literals.put(new ANTLRHashString("break", this), new Integer(63));
	literals.put(new ANTLRHashString("while", this), new Integer(58));
	literals.put(new ANTLRHashString("__declspec", this), new Integer(48));
	literals.put(new ANTLRHashString("typeof", this), new Integer(40));
	literals.put(new ANTLRHashString("__shared__", this), new Integer(23));
	literals.put(new ANTLRHashString("inline", this), new Integer(18));
	literals.put(new ANTLRHashString("unsigned", this), new Integer(35));
	literals.put(new ANTLRHashString("const", this), new Integer(22));
	literals.put(new ANTLRHashString("float", this), new Integer(32));
	literals.put(new ANTLRHashString("__mcuda_aligned", this), new Integer(26));
	literals.put(new ANTLRHashString("return", this), new Integer(64));
	literals.put(new ANTLRHashString("__builtin_va_arg", this), new Integer(105));
	literals.put(new ANTLRHashString("sizeof", this), new Integer(103));
	literals.put(new ANTLRHashString("do", this), new Integer(59));
	literals.put(new ANTLRHashString("__label__", this), new Integer(57));
	literals.put(new ANTLRHashString("__alignof__", this), new Integer(104));
	literals.put(new ANTLRHashString("__asm", this), new Integer(52));
	literals.put(new ANTLRHashString("__device__", this), new Integer(20));
	literals.put(new ANTLRHashString("typedef", this), new Integer(4));
	literals.put(new ANTLRHashString("if", this), new Integer(67));
	literals.put(new ANTLRHashString("double", this), new Integer(33));
	literals.put(new ANTLRHashString("volatile", this), new Integer(9));
	literals.put(new ANTLRHashString("__attribute", this), new Integer(51));
	literals.put(new ANTLRHashString("union", this), new Integer(12));
	literals.put(new ANTLRHashString("_Imaginary", this), new Integer(39));
	literals.put(new ANTLRHashString("register", this), new Integer(15));
	literals.put(new ANTLRHashString("auto", this), new Integer(14));
	literals.put(new ANTLRHashString("goto", this), new Integer(61));
	literals.put(new ANTLRHashString("enum", this), new Integer(13));
	literals.put(new ANTLRHashString("_Complex", this), new Integer(38));
	literals.put(new ANTLRHashString("int", this), new Integer(30));
	literals.put(new ANTLRHashString("for", this), new Integer(60));
	literals.put(new ANTLRHashString("char", this), new Integer(28));
	literals.put(new ANTLRHashString("__constant__", this), new Integer(24));
	literals.put(new ANTLRHashString("default", this), new Integer(66));
	literals.put(new ANTLRHashString("__host__", this), new Integer(21));
	literals.put(new ANTLRHashString("__imag", this), new Integer(110));
	literals.put(new ANTLRHashString("__builtin_offsetof", this), new Integer(106));
	literals.put(new ANTLRHashString("static", this), new Integer(17));
	literals.put(new ANTLRHashString("_Bool", this), new Integer(37));
	literals.put(new ANTLRHashString("continue", this), new Integer(62));
	literals.put(new ANTLRHashString("__restrict", this), new Integer(25));
	literals.put(new ANTLRHashString("bool", this), new Integer(36));
	literals.put(new ANTLRHashString("struct", this), new Integer(11));
	literals.put(new ANTLRHashString("signed", this), new Integer(34));
	literals.put(new ANTLRHashString("else", this), new Integer(68));
	literals.put(new ANTLRHashString("void", this), new Integer(27));
	literals.put(new ANTLRHashString("__global__", this), new Integer(19));
	literals.put(new ANTLRHashString("switch", this), new Integer(69));
	...
	literals.put(new ANTLRHashString("__complex", this), new Integer(43));
}
		...
		if ((LA(1)=='\t'||LA(1)=='\u000c'||LA(1)==' ')) {
			...
			do {
				if ((LA(1)=='\t'||LA(1)=='\u000c'||LA(1)==' ') && (true) && (true)) {
					...
					if ( _cnt442>=1 ) { break _loop442; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
...
inputState.guessing--;
	...
	public final void mCharLiteral(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		match('\'');
		{
		if ((LA(1)=='\\') && ((LA(2) >= '\u0000' && LA(2) <= '\u00ff')) && (_tokenSet_10.member(LA(3)))) {
			mEscape(false);
		}
		else if ((_tokenSet_11.member(LA(1))) && (LA(2)=='\'') && (true)) {
			{
			match(_tokenSet_11);
			}
		}
